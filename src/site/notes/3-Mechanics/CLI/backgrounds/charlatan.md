---
{"dg-publish":true,"permalink":"/3-mechanics/cli/backgrounds/charlatan/","tags":["ttrpg-cli/background","ttrpg-cli/compendium/src/5e/phb"]}
---
...
- **Equipment.** A set of [fine clothes](3-Mechanics/CLI/items/fine-clothes.md), a [disguise kit](3-Mechanics/CLI/items/disguise-kit.md), tools of the con of your choice (ten stoppered bottles filled with colored liquid, a set of weighted dice, a deck of marked cards, or a signet ring of an imaginary duke), and a belt [pouch](3-Mechanics/CLI/items/pouch.md) containing 15 gp  
...
| 6 | I convince people that worthless junk is worth their hard-earned money. |{ #scam}
...
| 8 | I pocket anything I see that might have some value. |{ #personality-trait}
...
| 6 | Aspiration. I'm determined to make something of myself. (Any) |{ #ideal}
...
| 6 | I swindled and ruined a person who didn't deserve it. I seek to atone for my misdeeds but might never be able to forgive myself. |{ #bond}
