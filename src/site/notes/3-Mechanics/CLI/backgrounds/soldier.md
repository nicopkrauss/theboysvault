---
{"dg-publish":true,"permalink":"/3-mechanics/cli/backgrounds/soldier/","tags":["ttrpg-cli/background","ttrpg-cli/compendium/src/5e/phb"]}
---
...
| 6 | Quartermaster |
| 7 | Standard-bearer |
| 8 | Support staff (cook, blacksmith, or the like) |{ #role}
...
| 8 | I face problems head-on. A simple, direct solution is the best path to success. |{ #personality-trait}
...
| 6 | Nation. My city, nation, or people are all that matter. (Any) |{ #ideal}
...
| 6 | I fight for those who cannot fight for themselves. |{ #bond}
