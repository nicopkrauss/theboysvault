---
{"dg-publish":true,"permalink":"/3-mechanics/cli/backgrounds/urchin/","tags":["ttrpg-cli/background","ttrpg-cli/compendium/src/5e/phb"]}
---
...
- **Equipment.** A small knife, a map of the city you grew up in, a pet mouse, a token to remember your parents by, a set of [common clothes](3-Mechanics/CLI/items/common-clothes.md), and a belt [pouch](3-Mechanics/CLI/items/pouch.md) containing 10 gp  
...
| 8 | I bluntly say what others are hinting at or hiding. |{ #personality-trait}
...
| 6 | Aspiration. I'm going to prove that I'm worthy of a better life. (Any) |{ #ideal}
...
| 6 | No one else should have to endure the hardships I've been through. |{ #bond}
