---
{"dg-publish":true,"permalink":"/3-mechanics/cli/bestiary/aberration/blue-slaad/","tags":["ttrpg-cli/compendium/src/5e/mm","ttrpg-cli/monster/cr/7","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/aberration"]}
---
...
> 
> Someone who is proficient in Wisdom ([Medicine](3-Mechanics/CLI/rules/skills.md#Medicine)) can remove the gem from an [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated) slaad. Each try requires 1 minute of uninterrupted work and a successful DC 20 Wisdom ([Medicine](3-Mechanics/CLI/rules/skills.md#Medicine)) check. Each failed attempt deals 22 (`4d10`) psychic damage to the slaad.{ #variant-slaad-control-gems}
...
- "desc": "Melee Weapon Attack: +8 to hit, reach 5 ft., one target. Hit: 12\
    ...
    \ slaad](3-Mechanics/CLI/bestiary/aberration/red-slaad.md) or, if it has the ability\
    \ to cast spells of 3rd level or higher, a [green slaad](3-Mechanics/CLI/bestiary/aberration/green-slaad.md).\
