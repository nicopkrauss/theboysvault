---
{"dg-publish":true,"permalink":"/3-mechanics/cli/bestiary/dragon/adult-brass-dragon/","tags":["ttrpg-cli/compendium/src/5e/mm","ttrpg-cli/monster/cr/13","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/dragon"]}
---
...
- "desc": "The dragon uses one of the following breath weapons.\n\n- Fire Breath.\
    ...
    \ area must succeed on a DC 18 Constitution saving throw or fall [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious)\
...
- "desc": "- A strong wind blows around the dragon. Each creature within 60 feet of\
    ...
    \ away from the dragon and knocked [prone](3-Mechanics/CLI/rules/conditions.md#Prone).\
  ...
  "name": ""
- "desc": "At your discretion, a legendary ([adult](3-Mechanics/CLI/bestiary/dragon/adult-brass-dragon.md)\
    ...
    \ and be knocked [prone](3-Mechanics/CLI/rules/conditions.md#Prone). Gases and\
    ...
    \ in the wind's direction, and the wind can't knock the dragon [prone](3-Mechanics/CLI/rules/conditions.md#Prone).\
