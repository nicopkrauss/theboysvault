---
{"dg-publish":true,"permalink":"/3-mechanics/cli/bestiary/fiend/chasme/","tags":["ttrpg-cli/compendium/src/5e/mm","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend/demon"]}
---
...
| 4 | nalfeshnee |
| 5 | marilith |
| 6 | balor, goristro |{ #demons-by-type}
...
> 
> A summoned demon appears in an unoccupied space within 60 feet of its summoner, acts as an ally of its summoner, and can't summon other demons. It remains for 1 minute, until it or its summoner dies, or until its summoner dismisses it as an action.{ #variant-demon-summoning}
...
- "desc": "The chasme produces a horrid droning sound to which demons are immune.\
    ...
    \ on a DC 12 Constitution saving throw or fall [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious)\
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one creature. Hit: 16\
    ...
    \ a long rest or until it is affected by a spell like  [greater restoration](3-Mechanics/CLI/spells/greater-restoration.md)."
  "name": "Proboscis"
"source":
- "MM"
