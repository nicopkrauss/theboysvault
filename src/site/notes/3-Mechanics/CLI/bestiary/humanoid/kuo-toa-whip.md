---
{"dg-publish":true,"permalink":"/3-mechanics/cli/bestiary/humanoid/kuo-toa-whip/","tags":["ttrpg-cli/compendium/src/5e/mm","ttrpg-cli/monster/cr/1","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/humanoid/kuo-toa"]}
---
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 10 ft., one target. Hit: 5\
    ...
    \ it is [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled) (escape DC 14).\
    \ Until this grapple ends, the kuo-toa can't use its pincer staff on another target."
  "name": "Pincer Staff"
"source":
- "MM"
"image": "3-Mechanics/CLI/bestiary/humanoid/token/kuo-toa-whip.webp"
```{ #statblock}
