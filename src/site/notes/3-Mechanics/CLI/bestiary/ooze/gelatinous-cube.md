---
{"dg-publish":true,"permalink":"/3-mechanics/cli/bestiary/ooze/gelatinous-cube/","tags":["ttrpg-cli/compendium/src/5e/mm","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/ooze"]}
---
...
- "desc": "The cube moves up to its speed. While doing so, it can enter Large or smaller\
    ...
    \ is [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained), and takes 21\
    \ (6d6) acid damage at the start of each of the cube's turns. When the cube\
