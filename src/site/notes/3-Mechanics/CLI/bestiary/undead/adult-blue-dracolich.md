---
{"dg-publish":true,"permalink":"/3-mechanics/cli/bestiary/undead/adult-blue-dracolich/","tags":["ttrpg-cli/compendium/src/5e/mm","ttrpg-cli/monster/cr/17","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/undead"]}
---
...
- "desc": "Each creature of the dracolich's choice that is within 120 feet of the\
    ...
    \ [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened) for 1 minute. A\
...
- "desc": "At your discretion, a legendary ([adult](3-Mechanics/CLI/bestiary/dragon/adult-blue-dragon.md)\
    \ or [ancient](3-Mechanics/CLI/bestiary/dragon/ancient-blue-dragon.md)) blue dragon\
    ...
    \ to the bottom of the pit, taking 7 (2d6) bludgeoning damage and landing [prone](3-Mechanics/CLI/rules/conditions.md#Prone).\
