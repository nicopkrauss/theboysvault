---
{"dg-publish":true,"permalink":"/3-mechanics/cli/items/trinket/","tags":["ttrpg-cli/compendium/src/5e/phb","ttrpg-cli/item/gear/","ttrpg-cli/item/rarity/none"]}
---

# Trinket
*Adventuring gear*  
![](3-Mechanics/CLI/items/img/trinket-phb.webp#right)
...
| 46 | A dead [sprite](3-Mechanics/CLI/bestiary/fey/sprite.md) inside a clear glass bottle |
...
| 81 | A purple handkerchief embroidered with the name of a powerful [archmage](3-Mechanics/CLI/bestiary/humanoid/archmage.md) |
...
| 100 | A metal urn containing the ashes of a hero |{ #players-handbook-trinket-table}
